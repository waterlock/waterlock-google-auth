...
GoogleOAuth2.prototype.rsaPublicKeyPem = function(modulus_b64, exponent_b64) {
...
GoogleOAuth2.prototype.prepadSigned = function(hexStr) {
  var msb = hexStr[0];
  if (msb < '0' || msb > '7') {
      return '00'+hexStr;
  } else {
...
GoogleOAuth2.prototype.toHex = function(number) {
...
// if <=127, short form
// if >=128, long form
GoogleOAuth2.prototype.encodeLengthHex = function(n) {
  if (n<=127) {
    return this.toHex(n);
  }
  else {
